...
public class UserController {
     ...
     *
     * @return ResponseEntity со списком пользователей в формате JSON и статусом 200 OK,
     * или статусом 500 в случае внутренней ошибки сервера
     */
     ...
     * или статусом 500 в случае ошибки
     */
     ...
     * или статусом 400 при невалидных данных, 500 при внутренней ошибке
     */
     ...
     * @return ResponseEntity с обновленными данными пользователя и статусом 200 OK,
     * или статусом 400/404/500 в случае ошибок
     */
     ...
     * или статусом 404/500 в случае ошибок
     */
